...
import 'category_school_view.dart';
...
class _PostsScreenState extends State<CatView> {
  String allposts;
  String v;
            ...
            Flexible(
              child: StreamBuilder(
                  stream: FirebaseFirestore.instance
                      .collection('cat').orderBy('name',descending: false).snapshots(),
